...
class SessionStore:
    ...
    def get_images(self, session_id: str, skip: int = 0, limit: int = 100) -> List[SessionImage]:
    ...
    def get_annotations(self, session_id: str, image_id: Optional[str] = None) -> List[SessionAnnotation]:
