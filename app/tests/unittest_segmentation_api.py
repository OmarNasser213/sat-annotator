...
class TestSegmentationAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        def segment_from_point(request_data: dict):
            ...
            try:
                ...
                return JSONResponse(
                    status_code=500,
                    content={"success": False, "detail": f"Segmentation failed: {str(e)}"}
                )
    ...
    def test_segment_from_point(self):
        ...
        # Prepare test data
        test_data = {
            "image_id": self.test_image.image_id,
            "point": [512, 384]
        }
        ...
        self.mock_segmenter.predict_from_point.assert_called_once_with(test_data["point"])
